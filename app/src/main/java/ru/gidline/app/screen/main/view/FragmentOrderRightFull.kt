...
class FragmentOrderRightFull : Fragment(){
    ...
    companion object {
        fun newInstance(cost: String?): FragmentOrderRightFull {
            val bundle = Bundle()
            bundle.putString("cost", cost)
            val fragment = FragmentOrderRightFull()
    ...
    override fun onCreateView(
        ...
        view = inflater.inflate(R.layout.fragment_order_right_full, container, false)
        ...
        spinnerGraphic.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                ...
                scheduleFragment.setTargetFragment(this@FragmentOrderRightFull, 3)
                fragmentManager?.let {
        ...
        listChoice.setOnClickListener(View.OnClickListener {
            ...
            fragmentWhant.setTargetFragment(this@FragmentOrderRightFull, 4)
            fragmentManager?.let {
