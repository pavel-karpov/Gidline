...
class OrderFragmentRight : Fragment(), AdapterView.OnItemSelectedListener {
    ...
    companion object {
        fun newInstance(cost: String?): OrderFragmentRight {
            val bundle = Bundle()
            bundle.putString("cost", cost)
            val fragment = OrderFragmentRight()
    ...
    override fun onCreateView(
        ...
        imageBtnCommit.setOnClickListener {
            checkComit?.let {
                if (it.isChecked.equals(false) || checBoxes().equals(false) || editName.text.length.equals(0)
        ...
        spinnerGraphic.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                ...
                scheduleFragment.setTargetFragment(this@OrderFragmentRight, 3)
                fragmentManager?.let {
        ...
        listChoice.setOnClickListener(View.OnClickListener {
            ...
            fragmentWhant.setTargetFragment(this@OrderFragmentRight, 4)
            fragmentManager?.let {
